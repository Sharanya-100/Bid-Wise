        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <p className="lead">
                Buy and sell items through real-time auctions. Find unique items
                or sell your valuables to the highest bidder.
              </p>
              <div className="mt-4">
            ...
            <div className="col-md-6 d-none d-md-block">
              <img
                src="/BidWise Auction House Logo.png"
      ...
      <div className="container mb-5">
        ...
        {loading ? (
          ...
          <div className="alert alert-info text-center">
            No active auctions found. Check back later or{" "}
            <Link to="/create-product">create your own</Link>!
          </div>
        )}
              ...
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    Sign up for free and create your profile to start buying or
                    selling items.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    List your items for auction or browse and bid on items that
                    interest you.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    Win auctions with the highest bid and complete the
